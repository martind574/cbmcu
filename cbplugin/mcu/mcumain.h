 ...
 * Author:    Martin Davey (martind@boltblue.com)
 * Created:   2008-07-14
 * Copyright: Martin Davey
 * License:   GPL
 **************************************************************/

#ifndef MCUMAIN_H_INCLUDED
#define MCUMAIN_H_INCLUDED
...
class mcu : public cbPlugin
{
    ...
    protected:
        ...
        void OnStartDebug(CodeBlocksEvent &event);
        void OnPauseDebug(CodeBlocksEvent &event);
        void OnStopDebug(CodeBlocksEvent &event);
        ...
        wxString m_Device;
        wxString m_Family;
        bool m_Open;    // Flag to specify project opened
